...
Il y aurait 16 fermes qui n'étaient plus suivies en 2020: 1, 12, 14, 15, 21, 23, 24, 28, 31, 32, 48, 57, 69, 73, 83, 102. Nous les retitons:
```{r}
...
write.csv(max.agg.amu2,"data/max.csv", row.names = FALSE)
```
...
write.csv(min.agg.amu2,"data/min.csv", row.names = FALSE)
