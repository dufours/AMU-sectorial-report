...
Trois tables seront nécessaires pour les calculs. Une avec les données par ferme-année (qui servira pour la plupart des figures de base), une autre avec les données par ferme-année-route d'administration (pour l'explosion des données par voie d'administration) et, finalement, une troisième table avec l'utilisation médiane par année par molécule. Pour cette dernière table, comme les données par ferme, par année et par molécule peuvent devenir très "minces", je crois qu'on pourrait simplement présenter les médianes (plutôt que les distributions complètes). Aussi, une "explosion" des données par voies d'administration deviendra probablement aussi trop "mince".
...
## Utilisation par molécule 
Calculer le taux médian d'utilisation par molécule par année pour les figures par molécule.
```{r}
#Calculer les médianes d'utilisation par molécule
mol.med <- setNames(
  aggregate(
    cbind(min.agg.amu$TYLOSIN_DCD, 
          min.agg.amu$CHLORTETRACYCLINE_DCD, 
          min.agg.amu$BENZYLPENICILLIN_P_DCD, 
          min.agg.amu$DIHYDROSTREPTOMYCIN_DCD, 
          min.agg.amu$POLYMYXINB_SULF_DCD, 
          min.agg.amu$CEFAPIRIN_DCD, 
          min.agg.amu$PIRLIMYCIN_DCD, 
          min.agg.amu$CEFTIOFUR_DCD, 
          min.agg.amu$CLOXACILLIN_DCD, 
          min.agg.amu$TRIM_SULFADOXINE_DCD, 
          min.agg.amu$OXYTETRACYCLINE_DCD, 
          min.agg.amu$AMPICILLIN_DCD, 
          min.agg.amu$TILMICOSIN_DCD, 
          min.agg.amu$BENZYLPENICILLIN_B_DCD, 
          min.agg.amu$ENROFLOXACIN_DCD, 
          min.agg.amu$DANOFLOXACIN_DCD, 
          min.agg.amu$TULATHROMYCIN_DCD, 
          min.agg.amu$GAMITROMYCIN_DCD, 
          min.agg.amu$TILDIPIROSIN_DCD, 
          min.agg.amu$MARBOFLOXACIN_DCD, 
          min.agg.amu$SULFANILAMIDE_DCD, 
          min.agg.amu$SULFATHIAZOLE_DCD, 
          min.agg.amu$STREPTOMYCIN_SULF_DCD, 
          min.agg.amu$SULFAMETHAZINE_DCD, 
          min.agg.amu$TETRACYCLINE_DCD, 
          min.agg.amu$NEOMYCIN_SULF_DCD, 
          min.agg.amu$SULFAMERAZINE_DCD, 
          min.agg.amu$SULFAGUANIDINE_DCD, 
          min.agg.amu$SUCCINYLSULFATHIAZOLE_DCD,
          
          min.agg.amu$TYLOSIN_DDD, 
          min.agg.amu$CHLORTETRACYCLINE_DDD, 
          min.agg.amu$BENZYLPENICILLIN_P_DDD, 
          min.agg.amu$DIHYDROSTREPTOMYCIN_DDD, 
          min.agg.amu$POLYMYXINB_SULF_DDD, 
          min.agg.amu$CEFAPIRIN_DDD, 
          min.agg.amu$PIRLIMYCIN_DDD, 
          min.agg.amu$CEFTIOFUR_DDD, 
          min.agg.amu$CLOXACILLIN_DDD, 
          min.agg.amu$TRIM_SULFADOXINE_DDD, 
          min.agg.amu$OXYTETRACYCLINE_DDD, 
          min.agg.amu$AMPICILLIN_DDD, 
          min.agg.amu$TILMICOSIN_DDD, 
          min.agg.amu$BENZYLPENICILLIN_B_DDD, 
          min.agg.amu$ENROFLOXACIN_DDD, 
          min.agg.amu$DANOFLOXACIN_DDD, 
          min.agg.amu$TULATHROMYCIN_DDD, 
          min.agg.amu$GAMITROMYCIN_DDD, 
          min.agg.amu$TILDIPIROSIN_DDD, 
          min.agg.amu$MARBOFLOXACIN_DDD, 
          min.agg.amu$SULFANILAMIDE_DDD, 
          min.agg.amu$SULFATHIAZOLE_DDD, 
          min.agg.amu$STREPTOMYCIN_SULF_DDD, 
          min.agg.amu$SULFAMETHAZINE_DDD, 
          min.agg.amu$TETRACYCLINE_DDD, 
          min.agg.amu$NEOMYCIN_SULF_DDD, 
          min.agg.amu$SULFAMERAZINE_DDD, 
          min.agg.amu$SULFAGUANIDINE_DDD, 
          min.agg.amu$SUCCINYLSULFATHIAZOLE_DDD),
    by=list(min.agg.amu$Year), FUN=median),
  c( "Year",
     "TYLOSIN_DCD",
     "CHLORTETRACYCLINE_DCD",
     "BENZYLPENICILLIN_P_DCD", 
...
write.csv(mol.med,"data/mol.csv", row.names = FALSE)
```
